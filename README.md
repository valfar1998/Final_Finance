...
1. Secrets GitHub (Settings → Secrets and variables → Actions):
   ...
   - opzionali: `FMP_API_KEY`, `TWELVE_DATA_API_KEY`, `POLYGON_API_KEY`, `ALPHA_VANTAGE_API_KEY`, `NEWSAPI_API_KEY`, `MARKETAUX_API_TOKEN`, `BENZINGA_API_TOKEN`, `GEMINI_API_KEY`, `NEWS_LLM_PROVIDER`, `SEC_CONTACT_EMAIL`, `FCA_*`, `FSA_EDINET_API_KEY`, `OPEN_DART_API_KEY`, `EODHD_API_TOKEN`, `TUSHARE_TOKEN`
